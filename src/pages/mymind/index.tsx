...
import MM from './_helper/mymind';
import { importLink } from '@/utils';

importLink('http://my-mind.github.io/css/style.css');
...
const Page = () => {
  useEffect(() => {
    ...
    var str =
      '{ "root": {"id": "ztemuzzo","text": "ssss", "layout": "map"}, "id": "pqlnmijv"}';
  ...
  return (
    <div>
      ...
      <div className="ui">
        ...
        <p>
          ...
          <button data-command="SaveAs" title="Save as">
            <img src="icons/save-as.png" alt="Save as" />
          </button>
        </p>
        ...
        <p>
          ...
          <select id="icons" className="fa-select">
            ...
            <option value="fa-asl-interpreting">
              &#xf2a3; asl-interpreting
            </option>
            ...
            <option value="fa-audio-description">
              &#xf29e; audio-description
            </option>
            ...
            <option value="fa-battery-three-quarters">
        ...
        <a
          id="github"
          href="https://github.com/ondras/my-mind"
          title="GitHub project page"
        >
          <img src="github.png" alt="GitHub project page" />
        </a>
        <a id="privacy" href="http://my-mind.github.io/PRIVACY.txt">
          Privacy policy
        </a>
        ...
        <button data-command="Notes" title="Notes">
      ...
      <div id="io" className="ui">
        ...
        <div id="local">
          <p className="desc">
            Your browser's localStorage can handle many mind maps and creates a
            permalink, but this URL cannot be shared.
          </p>
          <p data-for="load">
